      ...
      <section className="relative min-h-[70vh] flex items-center justify-center text-center">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="#contact"
              className="bg-green-500 text-white px-8 py-4 rounded-full font-semibold hover:bg-green-600 transition-colors transform hover:scale-105"
            >
              Contact Us
            </a>
            <a
              href="#services"
              className="bg-blue-900 text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-950 transition-colors transform hover:scale-105"
            >
              Our Services
            </a>
          </div>
